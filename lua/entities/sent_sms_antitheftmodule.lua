...
ENT.PrintName		= "Anti-Theft Module"
ENT.Author			= "KRisU"
...
function ENT:Use( activator, caller )
	...
	if ( activator:IsPlayer() ) then
		...
		activator:PrintMessage( HUD_PRINTTALK , ">> Safety first! You cannot be robbed in the next 250 seconds!" )
		
		timer.Simple( 249, function() 
			activator:SetNWBool( "antitheftEq", false ) 
			activator:PrintMessage( HUD_PRINTTALK , ">> Anti-Theft Module depleted!" )
		end)
