...
if (SERVER) then
	...
	function ENT:Destroy() -- VALID
		...
		if (Owner:GetInfoNum( "money_notifications", 1 ) == 1) then
			Owner:PrintMessage( HUD_PRINTTALK, ">> Money Printer exploded!" )
		end
	...
	function ENT:BurstIntoFlames()
		...
		if (Owner:GetInfoNum( "money_notifications", 1 ) == 1) then
			Owner:PrintMessage( HUD_PRINTTALK, ">> Money Printer overheated!" )
		end
	...
	function ENT:CreateMoneyBag()
		...
		if self.OverheatChance < 9 then
			if (Owner:GetInfoNum( "money_notifications", 1 ) == 1) then
				Owner:PrintMessage( HUD_PRINTTALK, ">> Money Printer critical!" )
			end
		end
